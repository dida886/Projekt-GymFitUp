...
public class Series_Table extends SQLiteOpenHelper {
    ...
    public Serie addDataSeries(String Weight, String Reps, String Time, int exercise_id, String Date) {
        ...
        contentValues.put(Series_Table.DATE_COL, Date);
        long result = db.insert(TABLE_NAME, null, contentValues);

        return new Serie(Long.toString(result), Weight, Reps, Time,Date);
    }
